<?php
/**********************************************************************************
* Subs-RealTabs.php - Function to reorganize Admin menu
*********************************************************************************
...
function RT_Reorganize(&$areas)
{
	global $txt;

	// Create a "Security" tab before the "Forum" tab and include "Security and Moderation" settings here:
	$new = array();
	...
	// Create "Modifications" tab using "Modifications Settings" area:
	$areas['mods'] = array(
	...
	// Remove most modifications from "Configuration" tab and put under "Modifications":
	...
	// Create "Package Manager" tab, removing it from "Main" tab:
